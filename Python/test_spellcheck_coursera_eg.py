...
def test_length(input_value):
    ...
    assert spellcheck_coursera_eg.word_count(input_value) < 10
    assert spellcheck_coursera_eg.char_count(input_value) < 50
...
def test_struc(input_value):
    ...
    """
    ### WRITE SOLUTION CODE HERE
    assert spellcheck_coursera_eg.first_char(input_value).isupper
    assert spellcheck_coursera_eg.last_char(input_value) == '.'
